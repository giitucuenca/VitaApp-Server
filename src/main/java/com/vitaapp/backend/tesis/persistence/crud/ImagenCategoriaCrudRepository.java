...
public interface ImagenCategoriaCrudRepository extends CrudRepository<ImagenCategoria, Integer> {
List<ImagenCategoria> findByIdCategoria(Integer idCategoria);
